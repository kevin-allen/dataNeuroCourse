...
Always break down your programming task into smaller tasks.

* Which column contains this information?
* How can we go from the values in the column to a statistic?
* What type(s) of plots to choose?
...
Also get the performance as before.
...
Plot the distribution of nonAlternation.
...
Time to commit and push your changes to your online repository.
