...
* Normally, you use the function `lm()` to find the best fitting (regression) line. 

* But to understand how machine learning works, we will do it step-by-step.
...
Calculate the difference between the actual and predicted y values. Return root mean square of the difference.
