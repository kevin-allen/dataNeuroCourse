...
### R
Open source language, statistical analysis, visualisation, R packages, RStudio


## Data science landscape

Recommendation: Invest your time in open source languages (`R` and `python`).

Both `R` and `python` are great for data analysis.

The most important point is to get the job done, ideally rapidely.

For the course, we will use mainly `R`. 
...
## Exercise 1.1 Data frames

1. Download the results from our Previous experience survey. 
  + Load it into R with the function `FCT` and save the results as a variable using `<-`.

2. Use built-in functions to.
  + Count how many students have experience with R.
  + Calculate the mean experience of students in months with data science.
  + Get the mean experience of the first 5 students in the data frame.
