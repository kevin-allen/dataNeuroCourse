...
It is your course, interupt me as often as you like.


## Previous experience

Short survey of the classroom.
...
In the end, the most important point is to get the job done.
...
TRICK: Use tab to complete the name of a fonction in RStudio.
...
5. What is the mean city miles per gallon for cars produced in 2008
...
1. Produce a boxplot showing the highway consumption for the different classes of car.
...
2. We find an extra date to replace the 7th of Noverber.
