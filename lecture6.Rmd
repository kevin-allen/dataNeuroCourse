...
## We worked with a very simple model: Linear regression
...
Deep convolutional neural networks became able to detect objects and classify images.

ImageNet competition: 1.3 million images and 1000 different classes
...
```{r, echo=FALSE,out.width = "700px"}
knitr::include_graphics("images/imageNet_features.png")
```
